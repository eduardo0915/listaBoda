    ...
    <q-card class="q-ma-md bg-grey-1">
      ...
      <q-card-section class="text-center">
        <span class="text-h6 text-secondary text-weight-bolder"
          ...
          >
            <span>Reportes de lista de bodas</span>
          </div>
        </span></q-card-section
      >
      <q-card-section>
        <table-reportes-regalos
...
export default {
  components: {
    ...
    TableReportesRegalos: defineAsyncComponent(() =>
      import("components/listaBoda/TableReportesRegalos.vue")
    ),
  },
